            ...
            <div class="card-body p-3">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        <p class="text-dark mb-0 tarefa-texto">{{ $tarefa['categoria'] }}</p>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <button class="btn btn-link text-primary p-0" data-bs-toggle="modal" data-bs-target="#modalEditarTarefa">
